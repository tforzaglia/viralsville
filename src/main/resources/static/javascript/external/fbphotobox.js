	...
	FBPhotoBox.prototype = {
		...
		initDOM: function() {
			var html = ['<div class="fbphotobox-main-container">',
				            '<div class="fbphotobox-container-top">',
								'<div class="fbphotobox-close-btn">',
									'<a title="Close" href="" style="float:right;margin:8px">',
										'<img src="./images/fbphotobox/close.png" style="height:10px;width:10px"/>',
									'</a>',
		...
		initSettings: function() {
			if (this.settings.topWidth != "") {
				$(".fbphotobox-container-top").css("width", this.settings.leftWidth);
			}
			...
			if (this.settings.topBgColor != "") {
				$(".fbphotobox-container-top").css("backgroundColor", this.settings.topBgColor);
			}
		...
		refreshBoxSize: function(image) {
			...
			var topContainer = $(".fbphotobox-container-top");
			var imageWidth = image.width;
			var imageHeight = image.height;
			var maxWidth = Math.max($(window).width() - this.settings.topWidth - this.settings.normalModeMargin*2, this.settings.minLeftWidth);
